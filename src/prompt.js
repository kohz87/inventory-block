...
`At the end of EVERY assistant response, emit exactly one complete <Inventory>...</Inventory> snapshot representing the full inventory after the events completed in that response. This is a full snapshot, never a patch, delta, JSON object, or partial list. Preserve every unchanged item and category exactly; omission means loss, so do not omit unchanged data.\n` +
